...
<body>
	...
	<div class="x-body">
		<table class="layui-table">
			...
			<tbody>
				<c:forEach items="${stuList}" var="record">
					<c:if test="${record.isPay == 0}">
						<tr>
							...
							<td class="td-status">
								<button class="layui-btn" id="${record.payNumber }"
									onclick="update(this.id)">缴费</button>
							</td>
						</tr>
					</c:if>
				</c:forEach>
	...
	<script>
		...
		function update(id) {
	    	...
	    	window.location.href = "/sisms/static/paymentManage_student/update?payNumber=" + id;
