...
<body>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<select type="text" id="applyKind" name="applyKind" required=""
						...
						<option value="借书">借书</option>
						<option value="预约">预约</option>
						<option value="还书">还书</option>
					</select>
				</div>
			</div>
			<div class="layui-form-item">
				<label for="username" class="layui-form-label"> <span
					class="x-red">*</span>bookID
				</label>
				<div class="layui-input-inline">
					<input type="text" id="other" name="other" required=""
						lay-verify="required" autocomplete="off" class="layui-input"></input>
				</div>
			</div>
			<div class="layui-form-item">
	...
	<script>
        layui.use(['form','layer'], function(){
          ...
          $(function(){
      	    $("#btn2").click(function(){
      	    	var newUrl = '<%=request.getContextPath() %>/dormManage/insertApply';    //设置新提交地址
