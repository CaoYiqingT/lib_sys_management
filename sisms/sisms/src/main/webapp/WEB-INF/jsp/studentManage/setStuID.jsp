...
<body class="layui-anim layui-anim-up">
	...
	<div class="x-body">
		...
		<button class="layui-btn"
			onclick="x_admin_show('批量编制','<%=request.getContextPath() %>/studentManage/setIDps',470,200)">
			<i class="layui-icon"></i>批量编制
		</button>
	<!--  	<button class="layui-btn" onclick="setDormClass()">
			<i class="layui-icon"></i>班级宿舍分配
		</button>    -->
    ...
    layui.use(['form'], function(){
      ...
      function setDormClass() {
    	  var queryData;
    	  $.ajax({
    		  type : 'POST',
    		  url : '<%=request.getContextPath() %>/studentManage/setDormClass',
    		  dataType : 'JSON',
    		  data : queryData,
    		  success : function(){},
    		  error : function(){
