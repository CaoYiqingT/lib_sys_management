...
<body>
	<div class="x-body layui-anim layui-anim-up">
		<form id="student" class="layui-form">
	...
	<script>
        layui.use(['form','layer'], function(){
          ...
          $(function(){
        	    $("#bt1").click(function(){
        	    	var newUrl = '<%=request.getContextPath() %>/studentManage/insertStudent';    //设置新提交地址
        	        $("#student").attr('action',newUrl);
        	        $("#student").submit();    //提交ID为myform的表单
