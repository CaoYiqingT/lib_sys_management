...
<body>
	<div class="x-body layui-anim layui-anim-up">
		<form id="myedit" class="layui-form">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="bookName" name="bookName" required=""
						value="${book.bookName} " lay-verify="required" autocomplete="off"
						class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="number" name="number" value="${book.number}"
						required="" lay-verify="required" autocomplete="off"
						class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="bookPrice" name="bookPrice"
						value="${book.bookPrice}" required="" lay-verify="required"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="requirment" name="requirment"
						value="${book.requirment}" required="" lay-verify="required"
						autocomplete="off" class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="semeter" name="semeter"
						value="${book.semeter}" required="" lay-verify="required"
						autocomplete="off" class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<c:if test="${empty book.providing}">
					<div class="layui-input-inline">
						<select type="text" id="providing" name="providing" required=""
							lay-verify="" autocomplete="off" class="layui-input">
	...
	<script>
        layui.use(['form','layer'], function(){
          ...
          $(function(){
        	    $("#bt1").click(function(){
        	    	var newUrl = '<%=request.getContextPath() %>/textBookManage/textUpdate';    //设置新提交地址
