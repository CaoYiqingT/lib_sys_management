		...
		<form id="adminform" class="layui-form">
			...
			<!-- <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                ...
                <input type="checkbox" name="like1[read]" lay-skin="primary" title="学生">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="password" id="identifyID" name="identifyID"
						required="" lay-verify="pass" autocomplete="off"
						class="layui-input">
				</div>
				<div class="layui-form-mid layui-word-aux">6个数字</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="password" id="reidentifyID" name="reidentifyID"
			...
			<div class="layui-form-item">
				...
				<button id="adminBtn" class="layui-btn">增加</button>
			</div>
		</form>
	</div>
	<script>
