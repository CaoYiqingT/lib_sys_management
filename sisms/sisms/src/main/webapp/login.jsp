...
<body class="login-bg">
   <ul class="layui-nav right" lay-filter="">
    ...
    <div class="login layui-anim layui-anim-up">
        <div class="message">Manarian Library</div>
        <div id="darkbannerwrap"></div>
        
        <form method="post" class="layui-form">
            <input id="userName" name="userName" placeholder="Username"  type="text" lay-verify="required" class="layui-input" >
            <hr class="hr15">
            <input id="password" name="password" lay-verify="required" placeholder="Password"  type="password" class="layui-input">
            <hr class="hr15">
            <input type="text" id="VerificationCode" name="VerificationCode"  placeholder="VerificationCode" class="verify" style="width:200px">
        ...
        <button value="登录" class="layui-btn" style="width:100%;height:50px;" type="submit" onclick="login()">Sign in</button>
        <a href="<%=request.getContextPath() %>/Pforget.jsp">Forget Password?</a>
        <hr class="hr20" >
    </div>
        	...
        	$.ajax({
        		...
        		success : function(data){
        			...
        			if(data.result == "admin") {
        				...
        				//alert("test");
        				window.location.href = "/sisms/studentLogin";
        				window.event.returnValue=false;
        			}else {
        				alert(data.result);
        			}
